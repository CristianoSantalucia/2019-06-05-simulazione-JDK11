...
public class Event implements Comparable<Event>
{
	...
	public Event(Integer district_id, LocalDateTime reported_date)
	{
	...
	@Override public boolean equals(Object obj)
	{
		...
		if (district_id == null)
		{
			if (other.district_id != null) return false;
		}
		else if (!district_id.equals(other.district_id)) return false;
		return true;
	}
